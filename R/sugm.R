...
#         S = S0
  ...
  if(method == "clime"){
    ...
    if(method == "clime"){
      ...
      re.sugm = sugm.clime.ladm.scr(y_Rachel, S, lambda, nlambda, n, d, maxdf, rho, shrink, prec, max.ite, verbose)
  ...
  ## rachel: icov1 contains result for i-th lambda
